...
import { entityRegistry, perm, actionPerm } from '../lib/entityRegistry'
...
export function EntityTable({
  ...
  const permShow = perm(config, model, 'show')
  const permEdit = perm(config, model, 'edit')
  const permDelete = perm(config, model, 'delete')

  const canShow = permShow !== false && can(permShow)
  const canEdit = permEdit !== false && can(permEdit)
  const canDelete = permDelete !== false && can(permDelete)
